...
from requests_mock import mock as RequestsMock
...
class TestMakeSession:
    ...
    def test_create_session_with_auth_token(self, monkeypatch):
        ...
        assert conn.auth.password == "hex_api_key"
...
class TestPerIssuePostPrequest:
    ...
    @pytest.mark.parametrize("issue_refs", (
        ["1", "2", "3"],
        [],
    ))
    ...
    def test_handle_http_errors_gracefully(self, requests_mock, monkeypatch):
        ...
        assert post_processor.click.echo.call_count == 4
    ...
    @pytest.mark.parametrize("cfg_body, exp_body", (
